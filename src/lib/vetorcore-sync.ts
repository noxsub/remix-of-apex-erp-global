...
/* ═══════════════════════════════════════════════════════════════
   ...
   ou Entradas mudam, os Key Results marcados com origemAuto são
   recalculados automaticamente. Monte este hook uma vez perto da
   raiz do app (ex: __root.tsx) para o recálculo rodar em qualquer
   tela, não só dentro do VetorCore.
   ═══════════════════════════════════════════════════════════════ */
